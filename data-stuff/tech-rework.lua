...
all_techs["automation-science-pack"] = nil -- No effects to unlock
...
local function create_tech(old_tech, name, level, pack, amount, modifiers, dependency, skip_extend)
	...
	elseif pack[2] and pack[2] == 1 then -- !!! Look into simplifying these "if" cases !!! (See above "!!!")
		for index = #tech.prerequisites, 1, -1 do -- Remove all pack prereqs to simplify inserting (!!! not needed?)
